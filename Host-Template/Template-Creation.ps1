...
$Shortcut = $WshShell.CreateShortcut("c:\Public\Desktop\Logoff.lnk")
$Shortcut.TargetPath = "C:\Windows\System32\logoff.exe"
$Shortcut.Save()

$WshShell = New-Object -comObject WScript.Shell
$Shortcut = $WshShell.CreateShortcut("c:\Public\Desktop\Admin Tools.lnk")
$Shortcut.TargetPath = "%windir%\system32\control.exe /name Microsoft.AdministrativeTools"
$Shortcut.Save()

$WshShell = New-Object -comObject WScript.Shell
$Shortcut = $WshShell.CreateShortcut("C:\Users\Administrator\AppData\Roaming\Microsoft\Windows\Start Menu\Programs\Startup\BG.lnk")
$Shortcut.TargetPath = "C:\Support\Scripts\BG-Startup.cmd"
$Shortcut.Save()
